...
import {IInitializableTToken} from "./IInitializableTToken.sol";

interface ITToken is IBEP20, IScaledBalanceToken, IInitializableTToken {
    /**
    ...
    /**
     * @dev Emitted after tTokens are burned
     * @param from The owner of the tTokens, getting them burned
    ...
    /**
     * @dev Returns address of treasury
     */
